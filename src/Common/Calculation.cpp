...
const double cm::Calculation::PI = 3.14159265358979323;
const float cm::Calculation::PIf = 3.141592653f;
const double cm::Calculation::EPS = 1e-7;
const float cm::Calculation::EPSf = 1e-7f;
